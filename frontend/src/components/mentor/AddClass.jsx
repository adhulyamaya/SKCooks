...
//   const mentorId = useSelector((state) => state.mentorsignup.mentorId);

//   // Check if mentorId is not null or undefined
//   if (mentorId) {
...
//       syllabus:createclass.value.syallabus,
//     }
...
//           <input type="text" name='classname' className='formcontrol'
//           onChange={e =>dispatch(setClassname(e.target.value))}/> 

//           <label htmlFor="classname">DESCRIPTION:</label>
//           <input type="text" name='description' className='formcontrol'
//           onChange={e =>dispatch(setDescription(e.target.value))}/> 

//           <label htmlFor="classname">PRICE:</label>
//           <input type="text" name='price' className='formcontrol'
//           onChange={e =>dispatch(setPrice(e.target.value))}/> 

//           <label htmlFor="classname">SYLLABUS:</label>
//           <input type="text" name='syllabus' className='formcontrol'
//           onChange={e =>dispatch(setSyllabus(e.target.value))}/>   
//         </div>
//       </form>
